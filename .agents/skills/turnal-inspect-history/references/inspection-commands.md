...
- `blame` uses the latest completed post checkpoint, not uncheckpointed workspace edits. Without `:line`, it reports every line. `--session` scopes both replay history and the latest checkpoint.
