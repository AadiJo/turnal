...
- The Turnal Activity Bar view can group recorded turns by session or show every turn in a newest-first Recent Activity list. Clicking a completed turn opens its changes in VS Code's native diff UI.
