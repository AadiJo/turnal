...
func captureStatusWorkspace(t *testing.T, agent string) string {
	...
	case "all":
		targets = []adapters.Target{adapters.TargetClaude, adapters.TargetCodex, adapters.TargetCopilot, adapters.TargetCursor, adapters.TargetGemini, adapters.TargetOpenCode, adapters.TargetPi}
	case "none":
		targets = nil
	default:
