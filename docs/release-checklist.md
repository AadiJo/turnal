...
- Verify all four macOS/Linux standalone archives and `checksums.txt` are attached to the GitHub release, and run the installer fixture test before publication.
